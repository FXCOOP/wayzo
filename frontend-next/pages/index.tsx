...
export default function HomePage() {
  return (
    <AppProvider>
      <Head>
        <title>Wayzo • AI-Powered Trip Planner</title>
        <meta name="description" content="Plan unforgettable trips in minutes with AI-powered personalized itineraries, smart routing, and budget optimization." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 via-white to-emerald-50">
        {/* Enhanced Navigation */}
        <Navigation />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xl font-bold">Wayzo</span>
                </div>
                <p className="text-slate-400 mb-4 max-w-md">
                  AI-powered trip planning that creates personalized itineraries with smart routing, 
                  budget optimization, and unforgettable experiences.
                </p>
            ...
            <div className="mt-8 pt-8 border-t border-slate-800">
              <p className="text-slate-400 text-sm text-center">
                © 2024 Wayzo. All rights reserved. Made with ❤️ for travelers worldwide.
              </p>
            </div>
          </div>
        </footer>
