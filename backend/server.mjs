...
Create the most amazing, detailed, and useful trip plan possible!`;
  ...
  const fallbackModel = 'gpt-5-nano-2025-08-07'; // Use GPT-5 nano for everything
  const visionModel = 'gpt-5-nano-2025-08-07'; // Use GPT-5 nano for images too
  const isNano = true; // Always use nano configuration
