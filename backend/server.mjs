...
const WAYZO_VERSION = 'staging-v7';
...
// also mount frontend at /frontend (so /frontend/style.css works)
...
// ---------- Affiliates (supports both env styles) ----------
const AFF = {
...
function looksComplete(md = '') { return REQUIRED_SECTIONS.every(h => md.includes(h)); }
