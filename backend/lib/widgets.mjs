...
// Affiliate Widgets Configuration - EXACT SPECIFICATIONS WITH IDS FOR MALDIVES
...
<script async src="https://tpwdgt.com/content?currency=usd&trs=455192&shmarker=634822&show_hotels=true&locale=en&powered_by=false&searchUrl=www.aviasales.com%2Fsearch&primary_override=%2332a8dd&color_button=%2355a539&color_icons=%2332a8dd&secondary=%23FFFFFF&dark=%23262626&light=%23FFFFFF&special=%23C4C4C4&color_focused=%2332a8dd&border_radius=5&plain=false&promo_id=7873&campaign_id=101" charset="utf-8"></script>`,
  ...
  // GetYourGuide Widget with EXACT specifications for Maldives
  getyourguide: {
...
function injectWidgetsIntoSections(html, widgets, destination = '') {
  ...
  try {
    ...
    // 2. Add Weather Forecast section after Trip Overview with 15-day Maldives weather
    ...
    if (tripOverviewH2) {
      ...
      weatherSection.innerHTML = `
        ...
        <table class="budget-table" style="border-collapse: collapse; border: 1px solid black; width: 100%;">
          ...
          <tbody>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 18</td><td style="border: 1px solid black; padding: 5px;">27°-31°</td><td style="border: 1px solid black; padding: 5px;">10%</td><td style="border: 1px solid black; padding: 5px;">Warm with light showers, ideal for beach</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 19</td><td style="border: 1px solid black; padding: 5px;">27°-31°</td><td style="border: 1px solid black; padding: 5px;">15%</td><td style="border: 1px solid black; padding: 5px;">Tropical warmth, perfect for snorkeling</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 20</td><td style="border: 1px solid black; padding: 5px;">26°-30°</td><td style="border: 1px solid black; padding: 5px;">20%</td><td style="border: 1px solid black; padding: 5px;">Warm with occasional showers</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 21</td><td style="border: 1px solid black; padding: 5px;">26°-30°</td><td style="border: 1px solid black; padding: 5px;">25%</td><td style="border: 1px solid black; padding: 5px;">Humid, great for water activities</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 22</td><td style="border: 1px solid black; padding: 5px;">25°-29°</td><td style="border: 1px solid black; padding: 5px;">30%</td><td style="border: 1px solid black; padding: 5px;">Rainy season, indoor activities recommended</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 23</td><td style="border: 1px solid black; padding: 5px;">25°-29°</td><td style="border: 1px solid black; padding: 5px;">35%</td><td style="border: 1px solid black; padding: 5px;">Frequent showers, perfect for spa days</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 24</td><td style="border: 1px solid black; padding: 5px;">24°-28°</td><td style="border: 1px solid black; padding: 5px;">40%</td><td style="border: 1px solid black; padding: 5px;">Heavy rain expected, resort activities</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 25</td><td style="border: 1px solid black; padding: 5px;">24°-28°</td><td style="border: 1px solid black; padding: 5px;">35%</td><td style="border: 1px solid black; padding: 5px;">Clearing up, good for diving</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 26</td><td style="border: 1px solid black; padding: 5px;">25°-29°</td><td style="border: 1px solid black; padding: 5px;">30%</td><td style="border: 1px solid black; padding: 5px;">Improving weather, beach time</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 27</td><td style="border: 1px solid black; padding: 5px;">25°-29°</td><td style="border: 1px solid black; padding: 5px;">25%</td><td style="border: 1px solid black; padding: 5px;">Pleasant, ideal for excursions</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 28</td><td style="border: 1px solid black; padding: 5px;">26°-30°</td><td style="border: 1px solid black; padding: 5px;">20%</td><td style="border: 1px solid black; padding: 5px;">Sunny intervals, great for water sports</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 29</td><td style="border: 1px solid black; padding: 5px;">26°-30°</td><td style="border: 1px solid black; padding: 5px;">15%</td><td style="border: 1px solid black; padding: 5px;">Mostly sunny, perfect beach weather</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Sep 30</td><td style="border: 1px solid black; padding: 5px;">27°-31°</td><td style="border: 1px solid black; padding: 5px;">10%</td><td style="border: 1px solid black; padding: 5px;">Excellent weather, ideal for all activities</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Oct 1</td><td style="border: 1px solid black; padding: 5px;">27°-31°</td><td style="border: 1px solid black; padding: 5px;">5%</td><td style="border: 1px solid black; padding: 5px;">Perfect tropical weather</td></tr>
            <tr><td style="border: 1px solid black; padding: 5px;">Oct 2</td><td style="border: 1px solid black; padding: 5px;">28°-32°</td><td style="border: 1px solid black; padding: 5px;">0%</td><td style="border: 1px solid black; padding: 5px;">Sunny departure day</td></tr>
          </tbody>
        </table>
      `;
      ...
      if (nextH2) {
        ...
        console.log('Weather forecast section injected successfully (15 days Maldives)');
      }
    }
