...
const AFFILIATE_WIDGETS = {
  ...
  airport_transfers: {
    ...
    script: `<script async src="https://tpwdgt.com/content?trs=455192&shmarker=634822&locale=en&show_header=true&powered_by=true&campaign_id=627&promo_id=8951" charset="utf-8"></script>`,
    category: "transport",
